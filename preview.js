...
import { installCanonicalBattleBattlerAssets } from "./runtime/canonical-battle-battler-assets.js?v=20260906-1500";
...
async function startPreview(action) {
  ...
  if (!appPromise) {
    ...
    appPromise = import("./preview-app.js?v=20260906-1830");
  }
  try {
    await appPromise;
