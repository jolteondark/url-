...
for(const name of ["safari-runtime-changed","safari-preview-start","safari-game-menu-opened","safari-game-menu-open-failed","safari-game-menu-closed","safari-normal-event-rendered","safari-normal-event-closed","safari-player-replacement-rendered","mapless-dppt-menu-changed","pageshow"])window.addEventListener(name,settle,{passive:true});
