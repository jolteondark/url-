...
import { resolveTrainerMoveChoiceFromBattleStateCanonical } from "./battle-core-trainer-choice-pipeline.js";
...
function prepareTrainerMove(runtime) {
  ...
  const resolution = resolveTrainerMoveChoiceFromBattleStateCanonical({
    candidates,
    skill,
