...
export async function openSafariTrainerCampTouch(runtime, index) {
  ...
  globalThis.__maplessNormalEventUi = { runtime, boardIndex:index, eventId:"trainer_camp", ...presentation };
  signalNormalEventUi();
  return { runtime, result:"trainer_camp_ready", boundary:"normal_event", notice:state.notice, operations:[] };
}
