...
// Canonical v0.9.108 Evolution Lab stat context. Base stats are generated only for species
// eligible for stable/maximum output from the v0.9.108 PBS + species_evolution.csv.
...
export function resolveEvolutionLabPokemonStatContextV108(pokemon) {
  ...
  return { success:true, result:"evolution_lab_stat_context_ready", base_stats, nature_stat_changes:NATURE[resolvedNature].map(([stat,amount])=>[stat,amount]), species, form, nature_id:resolvedNature };
}
