...
export const SAFARI_SPECIES_FORM_FRONT_ATLAS = Object.freeze({
  ...
  rows: 40,
  cellSize: 16,
  // Deployed WebP byte size. The canonical input-graphics digest below is the
  // stable provenance check; the compressed WebP may be regenerated by the
  // asset pipeline without changing sprite ordering/content ownership.
  byteLength: 7509,
  sha256: null,
  exactCount: 1654,
  fallbackCount: 15,
