...
export const PUBLISHED_CANONICAL_BATTLE_UI = Object.freeze({
  'ability_bar.png': Object.freeze({ canonicalGitBlobSha: 'c2dd369fc4839df86bfab3ef00fc0e2a8574bf41', bytes: 941 }),
  ...
  'cursor_mega.png': Object.freeze({ canonicalGitBlobSha: '0dafea4f5876c72a0f26eec9515832e1a1168636', bytes: 2131 }),
  'cursor_shift.png': Object.freeze({ canonicalGitBlobSha: '6045bfe396f7abe54ee48959a9c2589cece403c7', bytes: 608 }),
  ...
  'databox_safari.png': Object.freeze({ canonicalGitBlobSha: '5d85afa5b9af509632d664c856799ef5a4b93567', bytes: 1102 }),
  'databox_thin.png': Object.freeze({ canonicalGitBlobSha: 'cdfe85b98f31aa4c68884d267e99193fd6f4d74a', bytes: 756 }),
  'databox_thin_foe.png': Object.freeze({ canonicalGitBlobSha: '0c3a586cf977e31a3bc5cd68460ede0f4c11086a', bytes: 783 }),
  'icon_ball.png': Object.freeze({ canonicalGitBlobSha: '093721a9f94548d1c9128f6c68259735bb4753c2', bytes: 510 }),
  'icon_ball_empty.png': Object.freeze({ canonicalGitBlobSha: '5d784db19b91af9a9c63c0ad941aeb2e620bd371', bytes: 385 }),
  'icon_ball_faint.png': Object.freeze({ canonicalGitBlobSha: 'b98a4c7410d390a84d022b7abbe3e5dfa9994378', bytes: 502 }),
  'icon_ball_status.png': Object.freeze({ canonicalGitBlobSha: '06d84406bbcd0f33b9287855e37a0664d0f138f7', bytes: 496 }),
  'icon_mega.png': Object.freeze({ canonicalGitBlobSha: 'aaaf0b98663d23612f7ae9f8e420df58dae40392', bytes: 556 }),
  'icon_numbers.png': Object.freeze({ canonicalGitBlobSha: 'f7bfb20dbf580186b3674794203c7ecafa6330b1', bytes: 639 }),
  'icon_own.png': Object.freeze({ canonicalGitBlobSha: '33975e3b2c63dc00ebe1c386a77d927248800ba9', bytes: 390 }),
  'icon_primal_Groudon.png': Object.freeze({ canonicalGitBlobSha: '683eae62243c2d9be2cd6918f0b299e94f5c85ee', bytes: 645 }),
  'icon_primal_Kyogre.png': Object.freeze({ canonicalGitBlobSha: '6f7d3592b5f801df40f463881d3277ecafaf6eb0', bytes: 650 }),
  ...
  'judgment.png': Object.freeze({ canonicalGitBlobSha: '0d43454e9784ef60048e839262c057d82d1696dd', bytes: 681 }),
  'overlay_exp.png': Object.freeze({ canonicalGitBlobSha: '025c43b59ed4a55f7564296b54742b2a4dd02ac2', bytes: 92 }),
  ...
  'overlay_lineup.png': Object.freeze({ canonicalGitBlobSha: '2cb2a57d47d003d1b4aed5baebb0f691a458dd43', bytes: 328 }),
