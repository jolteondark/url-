...
assert.match(index, /\.\/runtime\/safari-pokemon-center-command\.js\?v=20260912-1700/);
assert.match(index, /\.\/runtime\/mapless-pokemon-center-healing\.js\?v=20260914-1700/);
assert.doesNotMatch(index, /\.\/runtime\/mapless-pokemon-center-healing\.js\?v=20260911-1902/);
...
assert.match(owner, /stats\.poke_center_count/);
assert.match(owner, /canonicalStat: "poke_center_count"/);
