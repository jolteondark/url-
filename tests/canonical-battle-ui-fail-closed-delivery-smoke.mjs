...
assert.match(preview, /canonical-battle-ui-assets\.js\?v=20260906-0100/, "reachable preview must request the complete fail-closed Battle UI adapter generation");
assert.doesNotMatch(preview, /canonical-battle-ui-assets\.js\?v=20260905-1600/, "reachable preview must not retain the stale Battle UI adapter generation");
assert.match(index, /preview\.js\?v=20260906-0100/, "public entry point must deliver the complete fail-closed preview generation");
assert.doesNotMatch(index, /preview\.js\?v=20260906-0030/, "public entry point must not retain the stale preview generation");
