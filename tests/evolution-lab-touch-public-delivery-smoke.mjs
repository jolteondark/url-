...
assert.match(index, /"\.\/runtime\/safari-pokemon-center-command\.js": "\.\/runtime\/safari-pokemon-center-command\.js\?v=20260912-1600"/);
assert.match(index, /"\.\/runtime\/safari-evolution-lab-touch\.js": "\.\/runtime\/safari-evolution-lab-touch\.js\?v=20260912-1600"/);
assert.doesNotMatch(index, /safari-pokemon-center-command\.js\?v=20260912-1400/);
