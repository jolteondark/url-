...
assert.match(
  indexSource,
  /"\.\/runtime\/safari-wishing-fountain-final-routes\.js": "\.\/runtime\/safari-wishing-fountain-final-routes\.js\?v=20260909-1255"/,
...
assert.doesNotMatch(
  ...
  "stale Wishing Fountain final-routes generations must not remain public",
);
assert.match(
  touchSource,
